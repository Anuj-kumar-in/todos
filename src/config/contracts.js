export const CONTRACT_ADDRESSES = {
  ...
  42161: {
    relayer: import.meta.env.VITE_ARBITRUM_RELAYER_ADDRESS || '0x0000000000000000000000000000000000000000',
  },
  421614: {
    relayer: import.meta.env.VITE_ARBITRUM_SEPOLIA_RELAYER_ADDRESS || '0x0000000000000000000000000000000000000000',
  },
  10: {
    relayer: import.meta.env.VITE_OPTIMISM_RELAYER_ADDRESS || '0x0000000000000000000000000000000000000000',
  },
  11155420: {
    relayer: import.meta.env.VITE_OPTIMISM_SEPOLIA_RELAYER_ADDRESS || '0x0000000000000000000000000000000000000000',
  },

  // ==================== POLYGON MAINNET ====================
  137: {
    relayer: import.meta.env.VITE_POLYGON_RELAYER_ADDRESS || '0x0000000000000000000000000000000000000000',
  },

  // ==================== POLYGON AMOY TESTNET ====================
  80002: {
    relayer: import.meta.env.VITE_POLYGON_AMOY_RELAYER_ADDRESS || '0x0000000000000000000000000000000000000000',
  },

  // ==================== BASE MAINNET ====================
  8453: {
    relayer: import.meta.env.VITE_BASE_RELAYER_ADDRESS || '0x0000000000000000000000000000000000000000',
  },

  // ==================== BASE SEPOLIA TESTNET ====================
  84532: {
    relayer: import.meta.env.VITE_BASE_SEPOLIA_RELAYER_ADDRESS || '0x0000000000000000000000000000000000000000',
  },

  // ==================== BLAST MAINNET ====================
  81457: {
    relayer: import.meta.env.VITE_BLAST_RELAYER_ADDRESS || '0x0000000000000000000000000000000000000000',
  },

  // ==================== BLAST SEPOLIA TESTNET ====================
  168587773: {
    relayer: import.meta.env.VITE_BLAST_SEPOLIA_RELAYER_ADDRESS || '0x0000000000000000000000000000000000000000',
  },

  // ==================== LINEA MAINNET ====================
  59144: {
    relayer: import.meta.env.VITE_LINEA_RELAYER_ADDRESS || '0x0000000000000000000000000000000000000000',
  },

  // ==================== LINEA SEPOLIA TESTNET ====================
  59141: {
    relayer: import.meta.env.VITE_LINEA_SEPOLIA_RELAYER_ADDRESS || '0x0000000000000000000000000000000000000000',
  },

  // ==================== SCROLL MAINNET ====================
  534352: {
    relayer: import.meta.env.VITE_SCROLL_RELAYER_ADDRESS || '0x0000000000000000000000000000000000000000',
  },

  // ==================== SCROLL SEPOLIA TESTNET ====================
  534351: {
    relayer: import.meta.env.VITE_SCROLL_SEPOLIA_RELAYER_ADDRESS || '0x0000000000000000000000000000000000000000',
  },

  // ==================== ZKSYNC MAINNET ====================
  324: {
    relayer: import.meta.env.VITE_ZKSYNC_RELAYER_ADDRESS || '0x0000000000000000000000000000000000000000',
  },

  // ==================== ZKSYNC SEPOLIA TESTNET ====================
  300: {
    relayer: import.meta.env.VITE_ZKSYNC_SEPOLIA_RELAYER_ADDRESS || '0x0000000000000000000000000000000000000000',
  },

  // ==================== BSC MAINNET ====================
  56: {
    relayer: import.meta.env.VITE_BSC_RELAYER_ADDRESS || '0x0000000000000000000000000000000000000000',
  },

  // ==================== BSC TESTNET ====================
  97: {
    relayer: import.meta.env.VITE_BSC_TESTNET_RELAYER_ADDRESS || '0x0000000000000000000000000000000000000000',
  },

  // ==================== AVALANCHE MAINNET ====================
  43114: {
    relayer: import.meta.env.VITE_AVALANCHE_RELAYER_ADDRESS || '0x0000000000000000000000000000000000000000',
  },

  // ==================== AVALANCHE FUJI TESTNET ====================
  43113: {
    relayer: import.meta.env.VITE_AVALANCHE_FUJI_RELAYER_ADDRESS || '0x0000000000000000000000000000000000000000',
  },

  // ==================== MANTLE MAINNET ====================
  5000: {
    relayer: import.meta.env.VITE_MANTLE_RELAYER_ADDRESS || '0x0000000000000000000000000000000000000000',
  },

  // ==================== MANTLE SEPOLIA TESTNET ====================
  5003: {
    relayer: import.meta.env.VITE_MANTLE_SEPOLIA_RELAYER_ADDRESS || '0x0000000000000000000000000000000000000000',
  },
  42220: {
    relayer: import.meta.env.VITE_CELO_RELAYER_ADDRESS || '0x0000000000000000000000000000000000000000',
  },
  31337: {
