...
import { CONTRACT_ADDRESSES, REWARD_DISTRIBUTION_ABI, TODO_TOKEN_ABI } from '../config/contracts'
...
export function useRewardsContract() {
    ...
    // Write: Claim all rewards
    const { writeContractAsync: claimWrite, isPending: isClaiming } = useWriteContract()
